    ...
    <body>
        <div class="container">
            ...
            <div class="container">
                ...
                <form method="POST" action="{{ route('books.update', ['book' => $books->id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <label for="title">Titulo</label>
                        <input class="form-control" type="text" name="title" value="{{ old('title') ?? $books->title }}">
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <input class="form-control" type="date" name="published_date"
                            value="{{ old('published_date') ?? $books->published_date }}">
                    </div>
                    ...
                    <div class="form-row mt-3 text-center">
                        <button class="btn btn-primary btn-lg" type="submit">Editar Libro</button>
                    </div>
